...
## About Me : 
I'm a Research Software Engineer at ICIQ, working on AI-driven robotics for catalyst development project, an interdisciplinary initiative aimed at accelerating catalyst discovery through automation and AI. My focus is on integrating machine learning models (neural networks, Bayesian optimization, random forests) for predictive property modeling and closed-loop experimental design. I develop custom hardware and software solutions, interfacing robotic arms, liquid handlers, and analytical instruments using Python, ROS, and LabVIEW, with real-time data acquisition and control via tools like PyMeasure, OpenLab CDS, and Xcalibur.

Prior to that I had developed the software for an intelligent parallel photoreactor with homogeneous light and high power density (up to 1.2 kW of 450 nm light). I have completed my Master’s in Embedded Systems Security in 2023 from [Grenoble INP Esisar](https://esisar.grenoble-inp.fr/), and an internship from [Schneider Electric](https://www.se.com/fr/fr/). I am passionate about Machine Learning, Embedded systems, FPGAs, microcontrollers, electronics, & robotics. I love to design and develop innovative robotics and automation devices for the betterment of society.
